        ...
        <section class="hero" id="home" aria-label="hero" style="background-image: url('./assets/images/hero-bg.jpg')">
            <div class="container">
                <div class="hero-content">
                    ...
                    <h2 class="h1 hero-title">Unlocking Edu, Shaping Futures.</h2>

                    <p class="hero-text">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus, rem nihil minima iste sunt, voluptate, 
                        fuga deserunt culpa vitae voluptas maxime facere cumque. In nam pariatur, molestias esse animi consequatur!
                    </p>

                    <a href="" class="btn btn-primary" target="_blank">
                        <span class="span">Look School Activities</span>
                        <ion-icon

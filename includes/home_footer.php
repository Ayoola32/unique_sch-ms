        ...
        <footer class="footer">
                <div class="container">
                    <div class="footer-top">
                        <div class="footer-brand">
                            ...
                            <p class="section-text">
                                The best school to teach students about their important education
                                and to empower their life, vision, and overall productivity with
                                great teachers.
                            </p>
                        ...
                        <ul class="footer-list">
                            ...
                            <li>
                                <a href="#" class="footer-link">
                                    <ion-icon name="chevron-forward" aria-hidden="true"></ion-icon>
                                    <span class="span">Instructors Profile</span>
                                </a>
                            </li>
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                ...
                                <a href="tel:+234" class="footer-link">
                                    +234111111
                                </a>
                            </li>
                    ...
                    <div class="footer-bottom">
                        <p class="copyright">
                            Copyright 2025 Unique School. All Rights Reserved by
        ...
        <!-- custom js link -->
        <script src="./includes/assets/js/script.js" defer></script>
        <!--- ionicon link-->
